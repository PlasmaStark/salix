...
This talk was my contribution to "Math Talks", the first event I organised by miself!, with the goal to showcase what is actually studied in mathematics.I enrolled other university students, one for each area of the Master's Degree in Mathematics at University of Trento.

![Math Talks!](/images/talks//2023-math-talks.webp)

The target audience was high school students: a broad audience with different background, perhaps even with little interest in mathematics. Therefore, the only prerequisite of this talk is knowing additions ($x+y=1$). 
