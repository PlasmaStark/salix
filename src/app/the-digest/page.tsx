    ...
    <main className="container mx-auto px-2 py-2">
      ...
      <section className="mb-12 relative w-full h-64 overflow-hidden rounded-lg shadow-2xl">
        ...
        <div className="absolute inset-0 bg-accent2light flex flex-col justify-center items-center p-4 z-10">
          <h1 className="text-5xl font-extrabold font-serif text-white tracking-wider text-center uppercase mb-2 drop-shadow-lg">
            THE DIGEST
          </h1>
          <p className="text-normal text-white drop-shadow-md text-center">
            Complex topics in short blocks.
          </p>
        </div>
      </section>
