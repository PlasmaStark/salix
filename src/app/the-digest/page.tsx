...
export default function TheDigestPage() {
  return (
    <main className="container mx-auto px-2 py-2">
      ...
      <section className="mb-12 relative w-full h-40 overflow-hidden rounded-lg shadow-2xl">
      ...
      <section className="mb-12">
        <p>
          <b>The Digest</b> is a monthly summary of advanced research concepts. <br></br>Here you can find the handouts of all upcoming and past episodes.
        </p>
      </section>
